...
const checklist = [
  ...
  'skill_crafting',
  'skill_stealth',
  'skill_practical_knowledge',
  'skill_rhetoric',
  'skill_flexing',
  'skill_insensibility',
  'skill_investigation',
  'skill_mystical_knowledge',
  'skill_navigation',
  'weapon_punch',
  'weapon_dagger',
  'weapon_fencing',
...
const parrymods = {
  'parry_weapon_punch': -3,
  'parry_weapon_dagger': -2,
  'parry_weapon_fencing': -1,
  'parry_weapon_swords': 0,
  'parry_weapon_impact': -2,
  'parry_weapon_polearm': 0,
  'parry_weapon_sling': 0,
  'parry_weapon_pistol': 0,
  'parry_weapon_crossbow': 0,
  'parry_weapon_musket': 0,
...
on("change:armor change:paralysisdamage", function () {
  getAttrs(["armor", "paralysisdamage", "ap"], function (values) {
    var armor = parseInt(values.armor, 10) || 1;
...
on("change:attribute_strength change:attribute_willpower change:hitpoints_mod", function () {
  getAttrs(["attribute_strength", "attribute_willpower", "hitpoints_mod"], function (values) {
...
on("change:attribute_senses change:attribute_dexterity change:ini_mod", function () {
  getAttrs(["attribute_senses", "attribute_dexterity", "ini_mod"], function (values) {
...
const skills = {
  'skill_academical_knowledge': { att: 'attribute_knowledge' },
  ...
  'skill_mystical_knowledge': { att: 'attribute_knowledge' },

  'skill_practical_knowledge': { att: 'attribute_knowledge' },
  'skill_investigation': { att: 'attribute_senses' },
